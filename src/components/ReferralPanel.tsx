...
export const ReferralPanel: React.FC<{ roleLabel: string }> = ({ roleLabel }) => {
  ...
  return <section style={{ marginTop: 22, padding: 16, borderRadius: 16, border: "1px solid var(--border)", background: "white" }}>
    ...
    <p style={{ margin: "5px 0 12px", color: "var(--text2)", fontSize: 12, lineHeight: 1.5, fontWeight: 700 }}>შენს პირად კოდს სისტემა ავტომატურად ქმნის. გაუზიარე მეგობარს — მისი აქტიური გამოყენების შემდეგ დაგერიცხება რეფერალის ქულები, რომლებსაც მომავალში აპლიკაციაში სხვადასხვა დანიშნულებით გამოიყენებ.</p>
