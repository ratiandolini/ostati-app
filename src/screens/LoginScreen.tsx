        ...
        >
          ...
          >
            ...
            <p style={{ margin: "0 0 14px", color: "var(--text2)", fontSize: 12, lineHeight: 1.5, fontWeight: 750 }}>
              FIXART-ის გამოყენებით მომხმარებელი თანხმდება პლატფორმის წესებსა და პირობებს. FIXART აკავშირებს კლიენტებსა და ხელოსნებს და არ წარმოადგენს შესრულებული სამუშაოს უშუალო შემსრულებელს. სამუშაოს პირობები, ფასი, ვადა და სხვა დეტალები მხარეებმა უნდა შეათანხმონ აპლიკაციის ჩატში. მომხმარებელი ვალდებულია მიუთითოს ზუსტი ინფორმაცია და არ გამოიყენოს პლატფორმა უკანონო, თაღლითური ან საზიანო მიზნებისთვის. პლატფორმის გამოყენება ექვემდებარება მოქმედ კანონმდებლობას და FIXART-ის მიმდინარე წესებს.
            </p>
            {[
